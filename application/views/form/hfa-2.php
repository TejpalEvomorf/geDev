...
<div class=" half_width_field">
			...
			<label for="hfa1_room_location" class="full_label">Room location <span class="reqField">*</span></label>
				<select class="half_input hfa_bedroom_floor student_room_location errorOnBlur" name="bedroom-<?=$x?>[student_room]" id="student_room-<?=$x;?>" >
...
<div class=" full_width_field">
			<span class="hfa1_app_full ">
			<label for="hfa1_room_location" class="full_label">Room location <span class="reqField">*</span></label>
				<select class="full_input hfa_bedroom_floor host_room_location errorOnBlur" name="hbedroom-<?php echo $x;?>[host_room]" id="host_room-<?php echo $x;?>" >
                <option value="" class="">Select one</option>
                  <?php foreach($roomLocation as $flK=>$flV){?>
...
<div class=" full_width_field">
 ...
 <div class=" full_width_field">
			...
			<label for="bathroom_floor-<?=$x?>" class="full_label">Bathroom Location <span class="reqField">*</span></label>
				<select class="full_input hfa_bedroom_floor bathroom_floor errorOnBlur" id="bathroom_floor-<?=$x;?>" name="bathroom-<?=$x?>[bathroom_floor]">
                <option value="">Select one</option>
                <?php foreach($roomLocation as $flK=>$flV){?>
	               	 <option class="sha_location" style="display: none;" value="<?=$flK?>"><?=$flV?></option>
                 <?php } ?>
