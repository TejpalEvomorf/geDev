...
<?php
if((isset($_GET['appStep']) && ($_GET['appStep']=='partial' || $_GET['appStep']=='complete')) || (isset($_GET['placement']) && ($_GET['placement']=='placed' || $_GET['placement']=='not_placed')) || (isset($_GET['appTourType']) &&($_GET['appTourType']=='yes' ||$_GET['appTourType']=='no')) || !empty($_GET['client']) || !empty($_GET['college']) || isset($_GET['appDuplicate']) || isset($_GET['appCaregivingDuration']) || isset($_GET['appMatchCollege'])){?>
  ...
  <?php if(isset($_GET['appStep']) &&($_GET['appStep']=='partial' ||$_GET['appStep']=='complete')){
    ...
    <?php }?>
     ...
     <?php } ?>
	  ...
	  <?php if(!empty($_GET['appCaregivingDuration'])){
		 $collegeDetail=collegeDetail($_GET['appCaregivingDuration']);
		// see($clientsListshause);
		 ?>
     <button class="mt-n btn btn-xs btn-danger btn-label hfaRemoveFilter pull-right" href="#" filter="appCaregivingDuration">
      <i class="fa fa-close"></i>
      Caregiving duration
    </button>
     <?php } ?>
     
	  <?php if(!empty($_GET['appMatchCollege'])){
		 $collegeDetail=collegeDetail($_GET['appMatchCollege']);
		// see($clientsListshause);
		 ?>
     <button class="mt-n btn btn-xs btn-danger btn-label hfaRemoveFilter pull-right" href="#" filter="appMatchCollege">
      <i class="fa fa-close"></i>
      College/Institution
    </button>
     <?php } ?>
...
if(isset($_GET['college']))
	...
	$appCaregivingDuration=0;
	if(isset($_GET['appCaregivingDuration']))
		$appCaregivingDuration=1;
	
	$appMatchCollege=0;
	if(isset($_GET['appMatchCollege']))
		$appMatchCollege=1;
 ?>
 ...
 <input type="hidden" name="appCaregivingDuration" value="<?=$appCaregivingDuration?>" />
 <input type="hidden" name="appMatchCollege" value="<?=$appMatchCollege?>" />
</form>
<script type="text/javascript">
  ...
  var appCaregivingDuration='<?=$appCaregivingDuration?>';
  var appMatchCollege='<?=$appMatchCollege?>';
