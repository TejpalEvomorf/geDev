                        ...
                        <li  style="padding-bottom: 0;" class="timeline-grey <?php if($valK>2){?>read-more-target<?php } ?>">
                            ...
                            <div class="timeline-body">
                                ...
                                <div class="timeline-header">
                                    ...
                                    <span data-id="<?php echo @$val['hfa_id'] ?>" data-postid="<?php echo @$val['id']?>" data-toggle="modal" data-target="#model_hfafamilynoteedit" class="notes-list-head author tyuedit" onclick="$('#clientfaAgreementseditParent').hide();"><?php  echo  $val['note_title']?></span>
                                    ...
                                    <span data-pid="<?php echo @$val['hfa_id'] ?>" data-id="<?php echo @$val['id']?>" class="note-delete notdel">×</span>
...
$("label[for='extraNotes']").click(function(){
	...
	$.ajax({
		...
		url:site_url+'hfa/familynotedocumentlist/'+id+'/'+noteid,
	...
	bootbox.dialog({
		...
		url:site_url+'hfa/deletenote/'+id,
