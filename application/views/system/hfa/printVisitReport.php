...
$styleTextLeftAlign=' style="text-align:left;"';
$styleTextLeftAlignWhite=' style="text-align:left;color:#fff;"';
?>
...
<div id="page-wrap">
  ...
  <div id="identity">
      <div id="logo" >
      <img style="margin: 15px 0 20px 0; height:100px;" src="<?=static_url()?>system/img/report-logo.jpg" />
            <h4 id="media-heading">Homestay Interview Report</h4>
		        ...
		        <div id="panel-body" class="">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <tr>
                                  <th <?=$styleTextLeftAlignWhite?>>Name: <span style="font-weight:normal;"><?=ucwords($host['lname']).' Family';?></span></th>
                              </tr>
