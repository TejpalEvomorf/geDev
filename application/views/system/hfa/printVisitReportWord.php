...
$styleTextLeftAlign=' style="text-align:left;padding-left: 10px;font-size:15px;font-family: barlow;"';
$styleTextLeftAlignWhite=' style="text-align:left;color:#fff;padding-left: 10px;font-size:15px;font-family: barlow;"';
$nbsb="&nbsp;&nbsp;";
?>
...
<div id="page-wrap">
  ...
  <div id="identity">
      <div id="logo">
      <!--<img style="margin: 15px 0 20px 0;" src="https://www.globalexperience.com.au/wp-content/uploads/2015/05/logo.jpg" />-->
      <!--<img style="margin: 15px 0 20px 0;" src="https://www.gediculture.com/ge/static/img/logo-invoice.jpg" />-->
      <img height="164" width="200" style="margin: 15px 0 50px 0;" src="<?=static_url()?>system/img/report-logo-word.jpg" />
  ...
  <div id="col-md-12">
    ...
    <!--Intro box #STARTS-->
        <div id="about-area" style="background:#888;">
            <div id="table-responsive" data-widget="{&quot;draggable&quot;: &quot;false&quot;}">
		        <div id="panel-body" class="">
                  
                      <table id="table" style="background:#888;">
                          <tbody>
                      
                              <tr>
                                  <th <?=$styleTextLeftAlignWhite?>><?=$nbsb?>Name: <span style="font-weight:normal;"><?=ucwords($host['lname']).' Family';?></span></th>
                              </tr>
                              
                              <tr>
                                  <th <?=$styleTextLeftAlignWhite?>><?=$nbsb?>Address: <span style="font-weight:normal;"><?=$address?></span></th>
                              </tr>
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <tr>
                                  <th <?=$styleTextLeftAlign?>>Homestay exterior appearance: 
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <tr><th <?=$styleTextLeftAlign?>><h2>Ground Floor/ First floor</h2></th></tr>
                              <tr>
              ...
              <th <?=$styleTextLeftAlign?>>Student bedrooms</th>
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
						...
						{?>
                              <tr><th <?=$styleTextLeftAlign?>><h2>Bedroom <?=$bedK+1?></h2></th></tr>
                              <tr>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  <th <?=$styleTextLeftAlign?>>Kitchen area: 
										...
										if($visitReport['sa_kitchen_comments']!='')
		                      ...
		                      <tr>
                                  <th <?=$styleTextLeftAlign?>>Backyard: 
										<?php
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <tr>
                                  <th <?=$styleTextLeftAlign?>>Do they have a granny flat? Does anyone live there? Please specify!: 
										<?php
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <!--<tr>
                                  <th <?=$styleTextLeftAlign?>>Experienced host? How many years of experience do you have?: 
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <tr>
                                  <th <?=$styleTextLeftAlign?>>Referral: 
                ...
                <div id="panel-body">
                      ...
                      <table id="table">
                          <tbody>
                              ...
                              <tr>
                                  <th <?=$styleTextLeftAlign?>>Additional comments: 
