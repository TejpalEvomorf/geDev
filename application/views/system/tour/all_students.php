                  ...
                  <tbody>
					  ...
					  ?>
												<tr id="shaApplication-<?php echo $studentV['id'];?>" role="row" class="odd">
													<td>
                                                    	<a style="text-transform:capitalize;" href="<?php echo site_url(),'sha/application/',$studentV['id'];?>" target="_blank"><?php echo $studentV['fname'],' ',$studentV['lname']; ?> </a><br>
														<a class="mailto" href="mailto:<?php echo $studentV['email']; ?>"><?php echo $studentV['email']; ?></a>
                                                    	<?php 
											...
											<td>
												<button class="mt-n mb-xs btn btn-sm btn-label" data-toggle="modal" data-target="#model_ChangeStatusSha" onclick="shaChangeStatusCancelPopContent(<?php echo $studentV['id'];?>,'all');" id="changeStatusHfaEditBtn-<?php echo $studentV['id'];?>">
...
<form id="tourFiltersFormHidden">
	...
	<input type="hidden" name="filterOption" value="all_students" />
</form>
