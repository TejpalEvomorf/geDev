<div class="page-heading">            
      <h1>
      	Dashboard
      	<small>Account statistics</small>
      </h1>
            ...
            <div class="panel-body no-padding table-responsive">
                ...
                <div class="list-group">
                    <div class="list-group-item withripple">
                        ...
                        <div class="row-content">
                            <div class="least-content">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_01.png" width="16" alt="icon">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_02.png" width="16" alt="icon">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_03.png" width="16" alt="icon">
                            </div>
                    ...
                    <div class="list-group-item withripple">
                        ...
                        <div class="row-content">
                            <div class="least-content">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_05.png" width="16" alt="icon">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_04.png" width="16" alt="icon">
                            </div>
                    ...
                    <div class="list-group-item withripple">
                        ...
                        <div class="row-content">
                            <div class="least-content">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_06.png" width="16" alt="icon">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_07.png" width="16" alt="icon">
                            </div>
                    ...
                    <div class="list-group-item withripple">
                        ...
                        <div class="row-content">
                            <div class="least-content">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_08.png" width="16" alt="icon">
                                <img class="img-circle" src="static/system/demo/avatar/avatar_09.png" width="16" alt="icon">
                            </div>
