...
<div class="pl-n m-n form-group col-xs-6">
  <label class="control-label">Booking start date</label>
      <div class="input-group date">
          ...
          <input type="text" class="form-control"  name="placeBooking_startDate" id="placeBooking_startDate" required>
      </div>
</div>
...
<div class="pl-n m-n form-group col-xs-6">
  <label class="control-label">Booking end date</label>
      <div class="input-group date">
          <span class="input-group-addon"><i class="colorDarkgreen material-icons">date_range</i></span>
          <input type="text" class="form-control"  name="placeBooking_endDate" id="placeBooking_endDate">
      </div>
</div>
...
<div class="form-group" style="position:unset;">
      ...
      <div class="col-sm-12">
		...
		<?php if($studentOne['study_tour_id']==0){?>
                <div class="form-group" style="clear:both;">
                      <div class="checkbox checkbox-primary" id="initialInvoiceDIv" style="clear:both;">
...
<input type="hidden" name="accomodation_type" value="<?=$_POST['filterMatchesEditAccomodation_type']?>" />
<input type="hidden" id="CHB_studyTourBooking" name="CHB_studyTourBooking" value="<?php if($studentOne['study_tour_id']==0){echo 0;}else{echo 1;}?>" />
<input type="hidden" name="owner" value="<?=$studentOne['employee']?>" />

<!--<p id="errorsCH" class="warningMsgCH" style="display:none"></p>-->
<div id="errorsCH" class="alert alert-info_orange ui-pnotify-container" style="display:none; clear:both;"></div>
