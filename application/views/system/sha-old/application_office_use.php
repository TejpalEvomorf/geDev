...
$duplicateShaFirst=getDuplicateShaFirst($formTwo['id'])
?>
<style type="text/css">
					...
					<input type="hidden" name="id" value="<?=$formOne['id']?>" />
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group col-xs-6" style="padding-left: 0;">
						 ...
						 <input type="text" class="form-control" id="shaBooking_week" data-parsley-type="number"  name="shaBooking_week"  value="<?=$formOne['weeks']?>"   onChange="updateShaBookingDates('week');" >
					  </div>
					   <div class="form-group col-xs-6" style="padding-right: 0;">
						  <label for="shaBooking_day" class="control-label">Days</label>
						 <input type="text" class="form-control" data-parsley-type="number" id="shaBooking_day" name="shaBooking_day"  value="<?=$formOne['days']?>"   onChange="updateShaBookingDates('day');" >
					  </div>
					  <!--<div class="row">
						  <div class="col-sm-8">
	...
	<div class="panel panel-profile panel-bluegraylight">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="id" id="studentid" value="<?=$formOne['id']?>" />
			  ...
			  ?>
										  <option data-bname="<?php echo @$cLV['bname']?>" data-sub="<?php  echo @$cLV['suburb']  ?>" data-add="<?php echo @$add ?>" value="<?=$cLV['id']?>" ><?=$cLV['bname']?></option>
									  <?php } ?>
						  </select>
				  </div>
				  <div class="form-group">
					  <label for="officeUse-student_college" class="control-label">Name of College/Institutions</label>
							  ...
							  <input type="text" class="form-control" id="officeUse-student_college" name="student_college" value="<?php echo @$formThree['college']?>" >
				  ...
				  <div class="form-group">
					  <label for="officeUse-sha_student_campus" class="control-label">Campus</label>
							  ...
							  <input type="text" class="form-control" id="officeUse-sha_student_campus" name="sha_student_campus" value="<?php echo @$formThree['campus']?>" >
					  
				  </div>
				  <div class="form-group">
					  <label for="officeUse-student_college_address" class="control-label">Address</label>
				  <textarea  class="form-control"  name="sha_student_college_address" id="officeUse-student_college_address"><?php echo @$formThree['college_address']?></textarea>
				  </div>
...
$("#officeClient,#officeUse-student_college_address,#officeUse-student_college,#officeUse-sha_student_campus").change(function(){
	...
	$.ajax({
			...
			type:'POST',
			data:{'college':$('#officeUse-student_college').val(),'sub':$('#officeUse-sha_student_campus').val(),'add':$('#officeUse-student_college_address').val(),'id':$('#studentid').val(),'cid':$('#officeClient').val()},
			success:function(data){
