...
<div class="page-heading report-page-heading">
      <h1>Caregiving service report</h1>
</div>
								...
								<legend style="display:none;">Report Options</legend>
                                		...
                                		<!--000000000-->
                                          ...
                                          <div class="col-md-4 no-pad">
										  	<?php $this->load->view('system/reports/caregiverRadioBtn');?>
                                          </div>
...
$(document).ready(function(){
	...
	$('#CaR_submit').click(function(){
			...
			$.ajax({
					url:'<?=site_url()?>Reports/caregiving_service_submit',
					type:'POST',
					data:formdata,
					success:function(data){
						...
						$('#CaR_submit').show();
						backBtn.show();
						window.open('<?=site_url()?>static/report/Caregiving_service.xls');	
					}
				});
		});
});
