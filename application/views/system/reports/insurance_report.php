                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <div class="col-md-4  no-pad-ryt">
                                                  <div class="panel panel-profile panel-bluegraylight">
                                                      ...
                                                      <div class="panel-body">
                                                          <?php foreach($insuranceStatusList as $wStatusK=>$wStatusV){?>
                                                              <div class="checkbox">
                                                                  <div class="checkbox block">
                                 ...
                                 <div class="col-md-12  no-pad-lft">
                                      <div class="panel panel-profile panel-bluegraylight">
                                          ...
                                          <div class="panel-body" style="text-align:left;">
                                              <input type="hidden" name="WR_field[]" value="id">
...
$(document).ready(function() {
    ...
    $('#WR_submit').click(function(){
			...
			$.ajax({
					url:'<?=site_url()?>Reports/insurance_submit',
					type:'POST',
					data:formdata,
					success:function(data){
						...
						$('#WR_submit').show();
						backBtn.show();
						window.open('<?=site_url()?>static/report/insurance_report.xls');	
					}
				});
		});
