								...
								<legend style="display:none;">Report Options</legend>
                                		...
                                		<!--000000000-->
                                          ...
                                          <div class="col-md-4 no-pad">
										  	<?php $this->load->view('system/reports/employeeRadioBtn');?>
                                          </div>
...
$(document).ready(function(){
		...
		next:function()
			{
						...
						var resultEmployee=validateSelectedEmployee();
						 if(resultEmployee=='notValid'){return false;} 						
						//date validation
	...
	$('#CaR_submit').click(function(){
			...
			$.ajax({
					url:'<?=site_url()?>Reports/booking_allocation_submit',
					type:'POST',
					data:formdata,
					success:function(data){
						...
						$('#CaR_submit').show();
						backBtn.show();
						window.open('<?=site_url()?>static/report/Booking_allocation.xls');	
					}
				});
		});
});
