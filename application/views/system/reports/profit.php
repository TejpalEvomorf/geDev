                                          ...
                                          <div class="col-md-6">
                                              <div class="  no-pad">
                                                  <div class="panel panel-profile panel-bluegraylight">
                                                      ...
                                                      <div class="panel-body">
                                                      <p style="margin-bottom:0;">Only the bookings that are active in the selected date range will be exported.</p>
...
$(document).ready(function(){
	...
	$('#CaR_submit').click(function(){
			...
			$.ajax({
					url:'<?=site_url()?>Reports/profit_submit',
					type:'POST',
					data:formdata,
					success:function(data){
						...
						$('#CaR_submit').show();
						backBtn.show();
						window.open('<?=site_url()?>static/report/profit_margin.xls');	
					}
				});
		});
});
