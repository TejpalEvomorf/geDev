...
if($page=='reports-booking_duration')
{
	$heading='Booking duration report';
	$contFunction='booking_duration_submit';
	$outputFile="Booking_duration";
}
elseif($page=='reports-parent_nominated_homestay')
{
	$heading='Parents nominated homestay';
	$contFunction='parent_nominated_homestay_submit';
	$outputFile="Parent_nominated_homestay";
}
?>
                                		...
                                		<!--000000000-->
                                          ...
                                          <div class="col-md-4">
                                              <div class="  no-pad">
                                                  ...
                                                  <div class="panel panel-profile panel-bluegraylight">
                                                      <div class="panel-heading">
                                                          <h2>Default booking end date</h2>
                                                      </div>
                                                      <div class="panel-body">
                                                      <p style="margin-bottom:0;">Bookings with booking end date not set will use this date as booking end date to calculate the booking duration</p>
                                                          
                                                              <div class="m-n form-group col-xs-12" style="padding-left:0;">
                                                                  <label class="control-label" style="margin-top:0;">Default booking end date</label>
                                                                  <input type="text" class="form-control" id="default_endDate" name="default_endDate" value="31/12/<?=date('Y')?>" readonly="readonly" style="cursor:text;">
                                                              </div>
                      
                                                      </div>
                                                  </div>
                                                  
                                                  <?php if($page=='reports-parent_nominated_homestay'){?>
                                                  <div class="panel panel-profile panel-bluegraylight">
                                                      <div class="panel-heading">
                                                          <h2>Nomination setting</h2>
                                                      </div>
                                                      <div class="panel-body">
                                                      <!--clients starts-->
                                                              <label  class="mt-n control-label filterItemLabel">Nominated host family and student should be linked in the booking?</label>
                                                              <div class="radio block">
                                                                  <label>
                                                                      <input type="radio" name="nominationSettingLink" value="yes"  checked>
                                                              ...
                                                              <div class="radio block" style="margin-top: -12px;">
                                                                  <label>
                                                                      <input type="radio" name="nominationSettingLink" value="no"  >
                                                                      <span class="circle"></span>
                                                                      <span class="check"></span>
                                                                      No
                                                                  </label>
...
$(document).ready(function(){
	...
	$('#CaR_fromDate, #CaR_toDate, #default_endDate').datepicker({
			orientation: "top",
			todayHighlight: true,
	    	/*startDate: "-0d",*/
			format:'dd/mm/yyyy',
    ...
    $('#CaR_submit').click(function(){
			...
			$.ajax({
					url:'<?=site_url()?>Reports/<?=$contFunction?>',
					type:'POST',
					data:formdata,
					success:function(data){
						...
						$('#CaR_submit').show();
						backBtn.show();
						window.open('<?=site_url()?>static/report/<?=$outputFile?>.xls');	
					}
				});
		});
});
