...
<div class="page-heading">
      <h1>
	  <?php 
	  	if($ongoing_invoice_status=='0')
	  		echo 'All ongoing invoices';
		else if($ongoing_invoice_status=='1')
	  		echo 'Pending';
		else if($ongoing_invoice_status=='2')	
			echo 'Partially paid';
		else
			echo 'Paid';
		?>
         ...
         <!--Sync button #STARTS-->
            <div class="pull-right">
                <button class="btn btn-danger syncInitialInvoicesBtn" id="syncInitialInvoicesBtn" onclick="syncOngoingInvoiceWithXero();">
                    ...
                    <div class="panel-body no-padding">
                        <table id="pendingInvoiceList" class="noborder0 table table-striped table-bordered table-fixed-header m-n" cellspacing="0" width="100%">
                            ...
                            <tbody>
								...
								{
									$ongoingInvoiceListTd=ongoingInvoiceListTd($invoice,$ongoing_invoice_status);
                                ...
                                <tr class="odd gradeX" id="invoice-<?=$invoice['id']?>">
                                  ...
                                  <td><?=$ongoingInvoiceListTd['td4']?></td>
                                  <td class="middle-alignment"><?=$ongoingInvoiceListTd['td_officeUse']?></td>
                                  <td>
                                       <div class="btn-group dropdown table-actions">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sidebar" role="menu">
                                            <li>
                                            	<?php if($invoice['moved_to_xero']==0){?>
                                            ...
                                            <li>
                                                <a href="<?=site_url()?>invoice/view_ongoing/<?=$invoice['id']?>" target="_blank"><i class="font16 material-icons">view_quilt</i>&nbsp;&nbsp;View invoice data</a>
                                            </li>
                                            <?php if(userAuthorisations('latest_ongInv_delete') && ifOngInvIsLatest($invoice['id'])){?>
                                                <li>
                                                    <a href="javascript:;" onclick="deleteOngoingInvoice(<?=$invoice['id']?>);" id="deleteOngoingInvoice-<?=$invoice['id']?>"><i class="font16 material-icons">delete</i>&nbsp;&nbsp;Delete</a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                        </div>
...
<form id="invoiceFiltersFormHidden">
 ...
 <input type="hidden" name="invoiceType" value="ongoing" />
	...
	if('<?=$invoiceSyncSummary?>'!='')
		{
			...
			$('#syncInvoicesUpToDate, #syncInvoicesPartial, #syncInvoicesPaid, #syncInvoicesPartialUpdated').hide();
			  ...
			  if(dataSplit[1]!=0)
				  $('#syncInvoicesPaid').text(dataSplit[1]+' invoice(s) moved to Paid invoices').show();
			  if(dataSplit[2]!=0)
					...
					<div class="modal-dialog">
						<div class="modal-content">
                            ...
                            <div class="modal-body">
                               ...
                               <input type="hidden" id="moveInitialInvoiceToXero_pageStatus" value="<?=$ongoing_invoice_status?>" />
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-success btn-raised" id="moveOngoingInvoiceToXeroSubmit">Yes</button>
					...
					<div class="modal-dialog">
                        ...
                        <div class="modal-header">
                         ...
                         <h2 class="modal-title">Sync With Xero Successful</h2>
							...
							<div class="modal-body">
                              <img src="<?=loadingImagePath()?>" id="syncInitialInvoicesPopProcess" height="150" style="margin: 0px 39%;"">
                              ...
                              <!--<span id="syncInvoicesPartial" class="colorLightgrey"></span>
                              <span id="syncInvoicesPartialUpdated" class="colorLightgrey"></span>
                              <span id="syncInvoicesPaid" class="colorLightgrey"></span>
                              <span id="syncInvoicesAppMoved" class="colorLightgrey"></span>-->
                              </div>
...
<script type="text/javascript">
var ongoing_invoice_statusPage='<?=$ongoing_invoice_status?>';
